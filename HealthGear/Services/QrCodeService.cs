...
public class QrCodeService
{
    ...
    public byte[] GenerateQrCode(int deviceId)
    {
        ...
        string localIp = httpContext.Connection.LocalIpAddress?.ToString() ?? "localhost";
        ...
        string url = $"{httpContext.Request.Scheme}://{localIp}:{httpContext.Request.Host.Port}/Device/Details/{deviceId}";
